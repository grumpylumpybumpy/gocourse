...
func main() {
	...
	// slices is like array but no fixed length
	...
	slice2 := slice1[2:4] //include the value at index 2 and 4-1=3
	fmt.Println(slice2)

	fmt.Println("The capacity of slice2 is", cap(slice2))
	// capacity of slice starts at different index not at 0
	// capacity counts the element beyond the length
